...
public class MotherBarrierSpawner {
    ...
    public static void trySpawn(ServerWorld world) {
        ...
        if (state.isGenerated()) {
            // DIAGNÓSTICO: se você está vendo essa linha repetida no console,
            // significa que o estado já está marcado como "gerado" — provavelmente
            // de um teste anterior. Apague a pasta de save (ou a entrada
            // "coolmod_motherbarrier.dat" dentro de world/data/) para resetar,
            // ou comente essa checagem temporariamente para forçar regeneração.
